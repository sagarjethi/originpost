      ...
      <div className="studio-workbench">
        <section className="studio-section">
          ...
          <div className="studio-ai-assist">
            ...
            <button type="button" onClick={() => void createAgentDraft()} disabled={!canEdit || Boolean(busy)}>{busy === "ai-draft" ? <RefreshCw className="analytics-spin" size={14} /> : <Sparkles size={14} />}{busy === "ai-draft" ? "Drafting…" : "Generate text"}</button>
          </div>
