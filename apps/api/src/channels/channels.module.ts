...
@Module({ exports: [CredentialVaultService], imports: [InfrastructureModule], controllers: [ChannelsController, ChannelOAuthController], providers: [ChannelsService, ConnectionDoctorService, ChannelOAuthService, CredentialVaultService] })
