...
describe("monitor sourcing selection", () => {
  ...
  it("collects mixed tracked sources explicitly and keeps general research on fallback", () => {
    ...
    expect(selectMonitorSourcingProvider(mixed, fallback, luma).id).toBe("public-tracked");
